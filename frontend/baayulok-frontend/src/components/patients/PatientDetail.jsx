...
function DetailItem({ label, value }) {
  return (
    <div>
      <label style={{ fontSize: '11.5px', fontWeight: 600, color: '#6B6860', textTransform: 'uppercase', letterSpacing: '0.04em', display: 'block', marginBottom: '4px' }}>
        {label}
      </label>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '20px' }}>
        ...
        <div>
          <label style={{ fontSize: '11.5px', fontWeight: 600, color: '#6B6860', textTransform: 'uppercase', letterSpacing: '0.04em', display: 'block', marginBottom: '8px' }}>
            Criticality score
          </label>
